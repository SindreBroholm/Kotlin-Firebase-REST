 ...
 * Use the [GenVIII.newInstance] factory method to
 * create an instance of this fragment.
 */
class GenVIII : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v =  inflater.inflate(R.layout.fragment_gen_v_i_i_i, container, false)

        val pokemonNameView = v?.findViewById<ListView>(R.id.lv_gen8)
        ...
        service.getGenVIII().enqueue(object : Callback<PokemonList> {
    ...
    companion object {
         ...
         * @return A new instance of fragment GenVIII.
         */
