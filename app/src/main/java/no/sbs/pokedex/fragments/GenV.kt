 ...
 * Use the [GenV.newInstance] factory method to
...
class GenV : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v =  inflater.inflate(R.layout.fragment_gen_v, container, false)

        val pokemonNameView = v?.findViewById<ListView>(R.id.lv_gen5)
        ...
        service.getGenV().enqueue(object : Callback<PokemonList> {
    ...
    companion object {
         ...
         * @return A new instance of fragment GenV.
         */
