 ...
 * Use the [GenVI.newInstance] factory method to
 * create an instance of this fragment.
 */
class GenVI : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v =  inflater.inflate(R.layout.fragment_gen_v_i, container, false)

        val pokemonNameView = v?.findViewById<ListView>(R.id.lv_gen6)
        ...
        service.getGenVI().enqueue(object : Callback<PokemonList> {
    ...
    companion object {
         ...
         * @return A new instance of fragment GenVI.
         */
