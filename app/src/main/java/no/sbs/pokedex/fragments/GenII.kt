 ...
 * Use the [GenII.newInstance] factory method to
 * create an instance of this fragment.
 */
class GenII : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v =  inflater.inflate(R.layout.fragment_gen_i_i, container, false)

        val pokemonNameView = v?.findViewById<ListView>(R.id.lv_gen2)
        ...
        service.getGenII().enqueue(object : Callback<PokemonList> {
    ...
    companion object {
         ...
         * @return A new instance of fragment GenII.
         */
