 ...
 * Use the [GenIII.newInstance] factory method to
 * create an instance of this fragment.
 */
class GenIII : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v =  inflater.inflate(R.layout.fragment_gen_i_i_i, container, false)

        val pokemonNameView = v?.findViewById<ListView>(R.id.lv_gen3)
        ...
        service.getGenIII().enqueue(object : Callback<PokemonList> {
    ...
    companion object {
         ...
         * @return A new instance of fragment GenIII.
         */
