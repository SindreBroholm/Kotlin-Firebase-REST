 ...
 * Use the [GenI.newInstance] factory method to
...
class GenI : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val v =  inflater.inflate(R.layout.fragment_gen_i, container, false)

        val pokemonNameView = v?.findViewById<ListView>(R.id.lv_gen1)
    ...
    companion object {
         ...
         * @return A new instance of fragment GenI.
         */
